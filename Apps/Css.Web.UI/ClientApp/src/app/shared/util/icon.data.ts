import { CompressedIconData } from 'src/app/modules/home/modules/system-admin/models/compressed-icon-data.interfaces';

export const ICON_DB: CompressedIconData[] = [
  {
