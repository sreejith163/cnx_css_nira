...
using Css.Api.Scheduling.Models.DTO.Response.SkillGroup;
...
namespace Css.Api.Scheduling.Business
{
    public class SkillGroupService : ISkillGroupService
    {
        ...
        public SkillGroupService(IRepositoryWrapper repository, IHttpContextAccessor httpContextAccessor, IMapper mapper)
        {
