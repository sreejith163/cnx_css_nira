...
{
    public class UpdateAgentCategoryCommandConsumer : IConsumer<UpdateAgentCategoryCommand>
    {
        /// <summary>
        /// The bus utility
        /// </summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="UpdateAgentCategoryCommandConsumer" /> class.</summary>
        /// <param name="busUtility">The bus utility.</param>
        /// <param name="agentCategoryRepository">The agentCategory repository.</param>
        /// <param name="uow">The uow.</param>
        public UpdateAgentCategoryCommandConsumer(IBusService busUtility, IAgentCategoryRepository agentCategoryRepository, IUnitOfWork uow)
        {
        ...
        public async Task Consume(ConsumeContext<UpdateAgentCategoryCommand> context)
        {
            try
            {
                ...
                agentCategory.Name = context.Message.NameNewValue;
                agentCategory.AgentCategoryType = (AgentCategoryType)context.Message.AgentCategoryTypeNewValue;
                agentCategory.DataTypeMinValue = context.Message.DataTypeMinValueNewValue;
                agentCategory.DataTypeMaxValue = context.Message.DataTypeMaxValueNewValue;
                ...
                await _busUtility.PublishEvent<IAgentCategoryUpdateSuccess>(MassTransitConstants.AgentCategoryUpdateSuccessRouteKey, new
                {
                    context.Message.Id
                });
            }
        ...
        /// <param name="context">The context.</param>
        private async Task PublishFailedEvent(ConsumeContext<UpdateAgentCategoryCommand> context)
        {
            await _busUtility.PublishEvent<IAgentCategoryUpdateFailed>(MassTransitConstants.AgentCategoryUpdateFailedRouteKey, new
            {
                context.Message.Id,
                context.Message.NameOldValue,
                context.Message.AgentCategoryTypeOldValue,
                context.Message.DataTypeMinValueOldValue,
                context.Message.DataTypeMaxValueOldValue,
