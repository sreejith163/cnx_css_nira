...
namespace Css.Api.Setup.EventHandlers.Faults.SkillGroup
{
    ...
    public class SkillGroupUpdateFailedFault : IConsumer<Fault<ISkillGroupUpdateFailed>>
    {
        ...
        ///   <br />
        /// </returns>
        public Task Consume(ConsumeContext<Fault<ISkillGroupUpdateFailed>> context)
        {
