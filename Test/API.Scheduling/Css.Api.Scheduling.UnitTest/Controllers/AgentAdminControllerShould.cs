...
namespace Css.Api.Scheduling.UnitTest.Controllers
{
    public class AgentAdminControllerShould
    {
        ...
        public async void MoveAgentAdmins()
        {
            ...
            mockAgentAdminService.Setup(mr => mr.MoveAgentAdmins(It.IsAny<MoveAgentAdminsDetails>())).ReturnsAsync((MoveAgentAdminsDetails moveAgentAdminsDetails) =>
              mockAgentAdminData.MoveAgentAdmins(moveAgentAdminsDetails));

            var value = await controller.MoveAgentAdmins(moveAgentAdminsDetails);
        ...
        public async void DeleteAgentAdmin_ReturnsNotFoundResult(string agentAdminId)
        {
            mockAgentAdminService.Setup(mr => mr.DeleteAgentAdmin(It.IsAny<AgentAdminIdDetails>())).ReturnsAsync(
                           ...
                           mockAgentAdminData.DeleteAgentAdmin(agentAdminIdDetails));
