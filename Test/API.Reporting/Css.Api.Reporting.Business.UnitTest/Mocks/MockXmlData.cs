    ...
    public class MockXmlData
    {
        ...
        private void InitializeAgentsData()
        {
            ...
            for (int i = 1; i<=10; i++)
            {
                ...
                sAgent.MUString = new Random().Next(300000, 400000).ToString();
                pAgent.FirstName = string.Concat("FP", i);
                pAgent.LastName = string.Concat("LP", i);
                pAgent.MUString = new Random().Next(400000, 500000).ToString();
            ...
            for (int i = 11; i <= 15; i++)
            {
                ...
                sAgent.MUString = new Random().Next(500000, 600000).ToString();
                pAgent.FirstName = string.Concat("UFP", i);
                pAgent.LastName = string.Concat("ULP", i);
                pAgent.MUString = new Random().Next(600000, 700000).ToString();
